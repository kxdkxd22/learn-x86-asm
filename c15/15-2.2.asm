...
;-------------------------------------------------------------------------------
         ...
         TaskGateB     db  '@TaskGateB'
                     times 256-($-TaskGateB) db 0
...
SECTION data vstart=0
         ...
         message_1        db  0x0d,0x0a
                          ...
                          db  'I am run at AAA program',0

         message_2        db  '.Now,I must exit AAA...',0x0d,0x0a,0
...
start:
         ...
         ;jmp far [fs:TaskGateB]      ;退出，并将控制权返回到核心
          ;call far [fs:TaskGateB]
